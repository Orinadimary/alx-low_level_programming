...
/**
 * print_magic - Prints magic digits on ELF header.
 * @e_ident: pointer to array with the ELF magic digits
 * Description: digits shouild be separated by space
 */
void print_magic(unsigned char *e_ident)
{
	int y;
 ...
 * Return: 0 on success.
 * Description: If file not ELF File
